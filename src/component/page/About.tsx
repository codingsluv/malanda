        ...
        <div className="w-full justify-start items-center gap-12 grid lg:grid-cols-2 grid-cols-1">
            <div
                ...
                <div className="pt-24 lg:justify-center sm:justify-end justify-start items-start gap-2.5 flex">
                    <img className=" rounded-xl object-cover" src="/assets/sate-1.jpeg" alt="about Us image" />
                </div>
                <img className="sm:ml-0 ml-auto rounded-xl object-cover" src="/assets/sate-2.jpeg"
                    alt="about Us image" />
            </div>
                ...
                <div className="w-full flex-col justify-center items-start gap-8 flex">
                    ...
                    <div className="w-full lg:justify-start justify-center items-center sm:gap-10 gap-5 inline-flex">
                        ...
                        <div className="flex-col justify-start items-start inline-flex">
                            ...
                            <h6 className="text-gray-500 text-base font-normal leading-relaxed">Pemesanan</h6>
                        </div>
                        <div className="flex-col justify-start items-start inline-flex">
                            <h4 className="text-gray-900 text-4xl font-bold font-manrope leading-normal">52000+</h4>
                            <h6 className="text-gray-500 text-base font-normal leading-relaxed">Pelanggan</h6>
                        </div>
                    </div>
                </div>
                <button
